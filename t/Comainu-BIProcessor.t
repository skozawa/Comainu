...
sub create_train_data : Test(3) {
    ...
    my $pos_gold = <<POS;
来る て テ て 助詞-接続助詞 助詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * て テ て 助詞-接続助詞 助詞 * * * * * * * * き クル 来る 動詞-非自立可能 動詞 * * カ行変格 * * 連用形-一般 連用形 * * * * * * * * * * * * * * * * * * * * * * * * * * * き クル 来る 動詞-非自立可能 動詞 * * カ行変格 * * 連用形-一般 連用形 * まし マス ます 助動詞 * * * 助動詞-マス 助動詞 * 連用形-一般 連用形 * * * * * * * * * * * * * * * * * * * * * * * * * * * まし マス ます 助動詞 * * * 助動詞-マス 助動詞 * 連用形-一般 連用形 * POS_080
ている 持っ モツ 持つ 動詞-一般 動詞 * * 五段-タ行 五段 * 連用形-促音便 連用形 * * * * * * * * * * * * * * * * * * * * * * * * * * * 持っ モツ 持つ 動詞-一般 動詞 * * 五段-タ行 五段 * 連用形-促音便 連用形 * て テ て 助詞-接続助詞 助詞 * * * * * * * * い イル 居る 動詞-非自立可能 動詞 * * 上一段-ア行 上一段 * 連用形-一般 連用形 * て テ て 助詞-接続助詞 助詞 * * * * * * * * い イル 居る 動詞-非自立可能 動詞 * * 上一段-ア行 上一段 * 連用形-一般 連用形 * ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * * * * * * * * * * * * * * * * * * * * * * * * * * * ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * POS_100
フリー 使える ツカウ 使う 動詞-一般 動詞 * * 下一段-ア行 下一段 * 連体形-一般 連体形 * * * * * * * * * * * * * * * * * * * * * * * * * * * 使える ツカウ 使う 動詞-一般 動詞 * * 下一段-ア行 下一段 * 連体形-一般 連体形 * フリー フリー フリー 名詞-普通名詞-形状詞可能 名詞 名詞-普通名詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * フリー フリー フリー 名詞-普通名詞-形状詞可能 名詞 名詞-普通名詞 * * * * * * * の ノ の 助詞-格助詞 助詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * の ノ の 助詞-格助詞 助詞 * * * * * * * * POS_000
ソフト の ノ の 助詞-格助詞 助詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * の ノ の 助詞-格助詞 助詞 * * * * * * * * ソフト ソフト ソフト 名詞-普通名詞-形状詞可能 名詞 名詞-普通名詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * ソフト ソフト ソフト 名詞-普通名詞-形状詞可能 名詞 名詞-普通名詞 * * * * * * * って ッテ って 助詞-副助詞 助詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * って ッテ って 助詞-副助詞 助詞 * * * * * * * * POS_000
有る って ッテ って 助詞-副助詞 助詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * って ッテ って 助詞-副助詞 助詞 * * * * * * * * あり アル 有る 動詞-非自立可能 動詞 * * 五段-ラ行 五段 * 連用形-一般 連用形 * * * * * * * * * * * * * * * * * * * * * * * * * * * あり アル 有る 動詞-非自立可能 動詞 * * 五段-ラ行 五段 * 連用形-一般 連用形 * ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * * * * * * * * * * * * * * * * * * * * * * * * * * * ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * POS_080
無い やっぱり ヤハリ 矢張り 副詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * やっぱり ヤハリ 矢張り 副詞 * * * * * * * * * ない ナイ 無い 形容詞-非自立可能 形容詞 * * 形容詞 * * 連体形-一般 連体形 * * * * * * * * * * * * * * * * * * * * * * * * * * * ない ナイ 無い 形容詞-非自立可能 形容詞 * * 形容詞 * * 連体形-一般 連体形 * の ノ の 助詞-準体助詞 助詞 * * * * * * * * でしょう デス です 助動詞 * * * 助動詞-デス 助動詞 * 意志推量形 * * の ノ の 助詞-準体助詞 助詞 * * * * * * * * でしょう デス です 助動詞 * * * 助動詞-デス 助動詞 * 意志推量形 * * POS_090

POS

    my $cType_gold = <<CTYPE;
来る て テ て 助詞-接続助詞 助詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * て テ て 助詞-接続助詞 助詞 * * * * * * * * き クル 来る 動詞-非自立可能 動詞 * * カ行変格 * * 連用形-一般 連用形 * * * * * * * * * * * * * * * * * * * * * * * * * * * き クル 来る 動詞-非自立可能 動詞 * * カ行変格 * * 連用形-一般 連用形 * まし マス ます 助動詞 * * * 助動詞-マス 助動詞 * 連用形-一般 連用形 * * * * * * * * * * * * * * * * * * * * * * * * * * * まし マス ます 助動詞 * * * 助動詞-マス 助動詞 * 連用形-一般 連用形 * POS_080 CTYPE_050
ている 持っ モツ 持つ 動詞-一般 動詞 * * 五段-タ行 五段 * 連用形-促音便 連用形 * * * * * * * * * * * * * * * * * * * * * * * * * * * 持っ モツ 持つ 動詞-一般 動詞 * * 五段-タ行 五段 * 連用形-促音便 連用形 * て テ て 助詞-接続助詞 助詞 * * * * * * * * い イル 居る 動詞-非自立可能 動詞 * * 上一段-ア行 上一段 * 連用形-一般 連用形 * て テ て 助詞-接続助詞 助詞 * * * * * * * * い イル 居る 動詞-非自立可能 動詞 * * 上一段-ア行 上一段 * 連用形-一般 連用形 * ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * * * * * * * * * * * * * * * * * * * * * * * * * * * ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * POS_100 CTYPE_020
フリー 使える ツカウ 使う 動詞-一般 動詞 * * 下一段-ア行 下一段 * 連体形-一般 連体形 * * * * * * * * * * * * * * * * * * * * * * * * * * * 使える ツカウ 使う 動詞-一般 動詞 * * 下一段-ア行 下一段 * 連体形-一般 連体形 * フリー フリー フリー 名詞-普通名詞-形状詞可能 名詞 名詞-普通名詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * フリー フリー フリー 名詞-普通名詞-形状詞可能 名詞 名詞-普通名詞 * * * * * * * の ノ の 助詞-格助詞 助詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * の ノ の 助詞-格助詞 助詞 * * * * * * * * POS_000 CTYPE_999
ソフト の ノ の 助詞-格助詞 助詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * の ノ の 助詞-格助詞 助詞 * * * * * * * * ソフト ソフト ソフト 名詞-普通名詞-形状詞可能 名詞 名詞-普通名詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * ソフト ソフト ソフト 名詞-普通名詞-形状詞可能 名詞 名詞-普通名詞 * * * * * * * って ッテ って 助詞-副助詞 助詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * って ッテ って 助詞-副助詞 助詞 * * * * * * * * POS_000 CTYPE_999
有る って ッテ って 助詞-副助詞 助詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * って ッテ って 助詞-副助詞 助詞 * * * * * * * * あり アル 有る 動詞-非自立可能 動詞 * * 五段-ラ行 五段 * 連用形-一般 連用形 * * * * * * * * * * * * * * * * * * * * * * * * * * * あり アル 有る 動詞-非自立可能 動詞 * * 五段-ラ行 五段 * 連用形-一般 連用形 * ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * * * * * * * * * * * * * * * * * * * * * * * * * * * ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * POS_080 CTYPE_009
無い やっぱり ヤハリ 矢張り 副詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * やっぱり ヤハリ 矢張り 副詞 * * * * * * * * * ない ナイ 無い 形容詞-非自立可能 形容詞 * * 形容詞 * * 連体形-一般 連体形 * * * * * * * * * * * * * * * * * * * * * * * * * * * ない ナイ 無い 形容詞-非自立可能 形容詞 * * 形容詞 * * 連体形-一般 連体形 * の ノ の 助詞-準体助詞 助詞 * * * * * * * * でしょう デス です 助動詞 * * * 助動詞-デス 助動詞 * 意志推量形 * * の ノ の 助詞-準体助詞 助詞 * * * * * * * * でしょう デス です 助動詞 * * * 助動詞-デス 助動詞 * 意志推量形 * * POS_090 CTYPE_130

CTYPE

    my $cForm_gold = <<CFORM;
来る て テ て 助詞-接続助詞 助詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * て テ て 助詞-接続助詞 助詞 * * * * * * * * き クル 来る 動詞-非自立可能 動詞 * * カ行変格 * * 連用形-一般 連用形 * * * * * * * * * * * * * * * * * * * * * * * * * * * き クル 来る 動詞-非自立可能 動詞 * * カ行変格 * * 連用形-一般 連用形 * まし マス ます 助動詞 * * * 助動詞-マス 助動詞 * 連用形-一般 連用形 * * * * * * * * * * * * * * * * * * * * * * * * * * * まし マス ます 助動詞 * * * 助動詞-マス 助動詞 * 連用形-一般 連用形 * POS_080 CTYPE_050 CFORM_030
ている 持っ モツ 持つ 動詞-一般 動詞 * * 五段-タ行 五段 * 連用形-促音便 連用形 * * * * * * * * * * * * * * * * * * * * * * * * * * * 持っ モツ 持つ 動詞-一般 動詞 * * 五段-タ行 五段 * 連用形-促音便 連用形 * て テ て 助詞-接続助詞 助詞 * * * * * * * * い イル 居る 動詞-非自立可能 動詞 * * 上一段-ア行 上一段 * 連用形-一般 連用形 * て テ て 助詞-接続助詞 助詞 * * * * * * * * い イル 居る 動詞-非自立可能 動詞 * * 上一段-ア行 上一段 * 連用形-一般 連用形 * ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * * * * * * * * * * * * * * * * * * * * * * * * * * * ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * POS_100 CTYPE_020 CFORM_030
フリー 使える ツカウ 使う 動詞-一般 動詞 * * 下一段-ア行 下一段 * 連体形-一般 連体形 * * * * * * * * * * * * * * * * * * * * * * * * * * * 使える ツカウ 使う 動詞-一般 動詞 * * 下一段-ア行 下一段 * 連体形-一般 連体形 * フリー フリー フリー 名詞-普通名詞-形状詞可能 名詞 名詞-普通名詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * フリー フリー フリー 名詞-普通名詞-形状詞可能 名詞 名詞-普通名詞 * * * * * * * の ノ の 助詞-格助詞 助詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * の ノ の 助詞-格助詞 助詞 * * * * * * * * POS_000 CTYPE_999 CFORM_999
ソフト の ノ の 助詞-格助詞 助詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * の ノ の 助詞-格助詞 助詞 * * * * * * * * ソフト ソフト ソフト 名詞-普通名詞-形状詞可能 名詞 名詞-普通名詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * ソフト ソフト ソフト 名詞-普通名詞-形状詞可能 名詞 名詞-普通名詞 * * * * * * * って ッテ って 助詞-副助詞 助詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * って ッテ って 助詞-副助詞 助詞 * * * * * * * * POS_000 CTYPE_999 CFORM_999
有る って ッテ って 助詞-副助詞 助詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * って ッテ って 助詞-副助詞 助詞 * * * * * * * * あり アル 有る 動詞-非自立可能 動詞 * * 五段-ラ行 五段 * 連用形-一般 連用形 * * * * * * * * * * * * * * * * * * * * * * * * * * * あり アル 有る 動詞-非自立可能 動詞 * * 五段-ラ行 五段 * 連用形-一般 連用形 * ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * * * * * * * * * * * * * * * * * * * * * * * * * * * ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * POS_080 CTYPE_009 CFORM_030
無い やっぱり ヤハリ 矢張り 副詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * やっぱり ヤハリ 矢張り 副詞 * * * * * * * * * ない ナイ 無い 形容詞-非自立可能 形容詞 * * 形容詞 * * 連体形-一般 連体形 * * * * * * * * * * * * * * * * * * * * * * * * * * * ない ナイ 無い 形容詞-非自立可能 形容詞 * * 形容詞 * * 連体形-一般 連体形 * の ノ の 助詞-準体助詞 助詞 * * * * * * * * でしょう デス です 助動詞 * * * 助動詞-デス 助動詞 * 意志推量形 * * の ノ の 助詞-準体助詞 助詞 * * * * * * * * でしょう デス です 助動詞 * * * 助動詞-デス 助動詞 * 意志推量形 * * POS_090 CTYPE_130 CFORM_060
...
sub create_BI_data_train : Test(3) {
    ...
    is $pos_dat, "ている 持っ モツ 持つ 動詞-一般 動詞 * * 五段-タ行 五段 * 連用形-促音便 連用形 *" .
        ...
        (" *" x 26) .
        " ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * POS_100\n\n";
    ...
    is $ctype_dat, "ている 持っ モツ 持つ 動詞-一般 動詞 * * 五段-タ行 五段 * 連用形-促音便 連用形 *" .
        ...
        "ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 *" .
        (" *" x 26) .
        " ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * POS_100 CTYPE_020\n\n";
    ...
    is $cform_dat, "ている 持っ モツ 持つ 動詞-一般 動詞 * * 五段-タ行 五段 * 連用形-促音便 連用形 *" .
        ...
        "ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 *" .
        (" *" x 26) .
        " ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * POS_100 CTYPE_020 CFORM_030\n\n";
...
sub create_BI_data_test : Test(3) {
    ...
    my $g = mock_guard("Comainu::BIProcessor" => {
        ...
        load_label   => sub {
            ...
            $self->{verb_labels} = ['POS_080', 'POS_081'];
            $self->{adj_labels}  = ['POS_090', 'POS_091'];
            $self->{aux_labels}  = ['POS_100'];
            $self->{part_labels} = ['POS_110', 'POS_111', 'POS_112'];
        },
    });
    ...
    is $pos_dat, "ている 持っ モツ 持つ 動詞-一般 動詞 * * 五段-タ行 五段 * 連用形-促音便 連用形 *" .
        ...
        (" *" x 26) .
        " ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * " .
        "POS_000 POS_080 POS_081 POS_090 POS_091\n\n";
    is $ctype_dat, "\n";
    is $cform_dat, "\n";
...
DATA
    ...
    $bip->{cType_verb_labels} = ['CTYPE_006', 'CTYPE_007'];
    $bip->{cType_adj_labels}  = ['CTYPE_130', 'CTYPE_140'];
    $bip->{cType_all_labels}  = ['CTYPE_006', 'CTYPE_007', 'CTYPE_130', 'CTYPE_140', 'CTYPE_165', 'CTYPE_170'];
    $bip->create_cType_dat($filename);

    my @buffs = split /\n/, $dat_buff;

    is $buffs[0], "来る て テ て 助詞-接続助詞 助詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * て テ て 助詞-接続助詞 助詞 * * * * * * * * き クル 来る 動詞-非自立可能 動詞 * * カ行変格 * * 連用形-一般 連用形 * * * * * * * * * * * * * * * * * * * * * * * * * * * き クル 来る 動詞-非自立可能 動詞 * * カ行変格 * * 連用形-一般 連用形 * まし マス ます 助動詞 * * * 助動詞-マス 助動詞 * 連用形-一般 連用形 * * * * * * * * * * * * * * * * * * * * * * * * * * * まし マス ます 助動詞 * * * 助動詞-マス 助動詞 * 連用形-一般 連用形 * POS_080 CTYPE_006 CTYPE_007";
    is $buffs[1], "ている 持っ モツ 持つ 動詞-一般 動詞 * * 五段-タ行 五段 * 連用形-促音便 連用形 * * * * * * * * * * * * * * * * * * * * * * * * * * * 持っ モツ 持つ 動詞-一般 動詞 * * 五段-タ行 五段 * 連用形-促音便 連用形 * て テ て 助詞-接続助詞 助詞 * * * * * * * * い イル 居る 動詞-非自立可能 動詞 * * 上一段-ア行 上一段 * 連用形-一般 連用形 * て テ て 助詞-接続助詞 助詞 * * * * * * * * い イル 居る 動詞-非自立可能 動詞 * * 上一段-ア行 上一段 * 連用形-一般 連用形 * ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * * * * * * * * * * * * * * * * * * * * * * * * * * * ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * POS_100 CTYPE_006 CTYPE_007 CTYPE_130 CTYPE_140 CTYPE_165 CTYPE_170";
    is $buffs[2], "フリー 使える ツカウ 使う 動詞-一般 動詞 * * 下一段-ア行 下一段 * 連体形-一般 連体形 * * * * * * * * * * * * * * * * * * * * * * * * * * * 使える ツカウ 使う 動詞-一般 動詞 * * 下一段-ア行 下一段 * 連体形-一般 連体形 * フリー フリー フリー 名詞-普通名詞-形状詞可能 名詞 名詞-普通名詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * フリー フリー フリー 名詞-普通名詞-形状詞可能 名詞 名詞-普通名詞 * * * * * * * の ノ の 助詞-格助詞 助詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * の ノ の 助詞-格助詞 助詞 * * * * * * * * POS_000 CTYPE_999";
}
...
DATA
    ...
    my @buffs = split /\n/, $dat_buff;
    is $buffs[0], "来る て テ て 助詞-接続助詞 助詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * て テ て 助詞-接続助詞 助詞 * * * * * * * * き クル 来る 動詞-非自立可能 動詞 * * カ行変格 * * 連用形-一般 連用形 * * * * * * * * * * * * * * * * * * * * * * * * * * * き クル 来る 動詞-非自立可能 動詞 * * カ行変格 * * 連用形-一般 連用形 * まし マス ます 助動詞 * * * 助動詞-マス 助動詞 * 連用形-一般 連用形 * * * * * * * * * * * * * * * * * * * * * * * * * * * まし マス ます 助動詞 * * * 助動詞-マス 助動詞 * 連用形-一般 連用形 * POS_080 CTYPE_050 CFORM_000 CFORM_010 CFORM_011 CFORM_100";
    is $buffs[1], "ている 持っ モツ 持つ 動詞-一般 動詞 * * 五段-タ行 五段 * 連用形-促音便 連用形 * * * * * * * * * * * * * * * * * * * * * * * * * * * 持っ モツ 持つ 動詞-一般 動詞 * * 五段-タ行 五段 * 連用形-促音便 連用形 * て テ て 助詞-接続助詞 助詞 * * * * * * * * い イル 居る 動詞-非自立可能 動詞 * * 上一段-ア行 上一段 * 連用形-一般 連用形 * て テ て 助詞-接続助詞 助詞 * * * * * * * * い イル 居る 動詞-非自立可能 動詞 * * 上一段-ア行 上一段 * 連用形-一般 連用形 * ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * * * * * * * * * * * * * * * * * * * * * * * * * * * ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * POS_100 CTYPE_020 CFORM_000 CFORM_010 CFORM_011 CFORM_100";
    is $buffs[2], "フリー 使える ツカウ 使う 動詞-一般 動詞 * * 下一段-ア行 下一段 * 連体形-一般 連体形 * * * * * * * * * * * * * * * * * * * * * * * * * * * 使える ツカウ 使う 動詞-一般 動詞 * * 下一段-ア行 下一段 * 連体形-一般 連体形 * フリー フリー フリー 名詞-普通名詞-形状詞可能 名詞 名詞-普通名詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * フリー フリー フリー 名詞-普通名詞-形状詞可能 名詞 名詞-普通名詞 * * * * * * * の ノ の 助詞-格助詞 助詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * の ノ の 助詞-格助詞 助詞 * * * * * * * * POS_000 CTYPE_999 CFORM_999";
...
sub merge_data : Test(2) {
    my $g = mock_guard('Comainu::BIProcessor' => {
        read_from_out => sub {
            my ($self, $file) = @_;
            return "POS_080 POS_000"   if $file =~ /BI_pos/;
            return "CTYPE_050 CTYPE_999" if $file =~ /BI_cType/;
            return "CFORM_030 CFORM_999" if $file =~ /BI_cForm/;
            return "";
        },
    });
    ...
    my $bip = Comainu::BIProcessor->new;
    $bip->{pos_label} = { "動詞-一般" => "POS_080", "名詞-普通名詞-一般" => "POS_000" };
    $bip->{cType_label} = {};
    $bip->{cForm_label} = {};
...
sub read_from_out : Test(1) {
    my $data = <<DATA;
暇\t「\t*\t「\t補助記号-括弧開\t補助記号\t括弧開\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t「\t*\t「\t補助記号-括弧開\t補助記号\t括弧開\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t暇\tヒマ\t暇\t名詞-普通名詞-形状詞可能\t名詞\t普通名詞\t形状詞可能\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t暇\tヒマ\t暇\t名詞-普通名詞-形状詞可能\t名詞\t普通名詞\t形状詞可能\t*\t*\t*\t*\t*\t*\t*\t*\t*\tな\tダ\tだ\t助動詞\t助動詞\t*\t*\t*\t助動詞-ダ\t助動詞\tダ\t*\t連体形-一般\t連体形\t一般\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\tな\tダ\tだ\t助動詞\t助動詞\t*\t*\t*\t助動詞-ダ\t助動詞\tダ\t*\t連体形-一般\t連体形\t一般\t*\tPOS_030
時\tな\tダ\tだ\t助動詞\t助動詞\t*\t*\t*\t助動詞-ダ\t助動詞\tダ\t*\t連体形-一般\t連体形\t一般\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\tな\tダ\tだ\t助動詞\t助動詞\t*\t*\t*\t助動詞-ダ\t助動詞\tダ\t*\t連体形-一般\t連体形\t一般\t*\t時\tトキ\t時\t名詞-普通名詞-副詞可能\t名詞\t普通名詞\t副詞可能\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t時\tトキ\t時\t名詞-普通名詞-副詞可能\t名詞\t普通名詞\t副詞可能\t*\t*\t*\t*\t*\t*\t*\t*\t*\tに\tニ\tに\t助詞-格助詞\t助詞\t格助詞\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\tに\tニ\tに\t助詞-格助詞\t助詞\t格助詞\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\tPOS_000
為る\tに\tニ\tに\t助詞-格助詞\t助詞\t格助詞\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\tに\tニ\tに\t助詞-格助詞\t助詞\t格助詞\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\tし\tスル\t為る\t動詞-非自立可能\t動詞\t非自立可能\t*\t*\tサ行変格\tサ行変格\t*\t*\t連用形-一般\t連用形\t一般\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\t*\tし\tスル\t為る\t動詞-非自立可能\t動詞\t非自立可能\t*\t*\tサ行変格\tサ行変格\t*\t*\t連用形-一般\t連用形\t一般\t*\tたら\tタ\tた\t助動詞\t助動詞\t*\t*\t*\t助動詞-タ\t助動詞\tタ\t*\t仮定形-一般\t仮定形\t一般\t*\tいい\tヨイ\t良い\t形容詞-非自立可能\t形容詞\t非自立可能\t*\t*\t形容詞\t形容詞\t*\t*\t終止形-一般\t終止形\t一般\t*\tたら\tタ\tた\t助動詞\t助動詞\t*\t*\t*\t助動詞-タ\t助動詞\tタ\t*\t仮定形-一般\t仮定形\t一般\t*\tいい\tヨイ\t良い\t形容詞-非自立可能\t形容詞\t非自立可能\t*\t*\t形容詞\t形容詞\t*\t*\t終止形-一般\t終止形\t一般\t*\tPOS_080
...
DATA
    ...
    is $outdata, "POS_030 POS_000 POS_080 POS_100 ";
};
