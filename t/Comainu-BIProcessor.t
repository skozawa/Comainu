...
DATA
    ...
    my @buffs = split /\n/, $dat_buff;
    is $buffs[0], "来る て テ て 助詞-接続助詞 助詞 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * て テ て 助詞-接続助詞 助詞 * * * * * * * * き クル 来る 動詞-非自立可能 動詞 * * カ行変格 * * 連用形-一般 連用形 * * * * * * * * * * * * * * * * * * * * * * * * * * * き クル 来る 動詞-非自立可能 動詞 * * カ行変格 * * 連用形-一般 連用形 * まし マス ます 助動詞 * * * 助動詞-マス 助動詞 * 連用形-一般 連用形 * * * * * * * * * * * * * * * * * * * * * * * * * * * まし マス ます 助動詞 * * * 助動詞-マス 助動詞 * 連用形-一般 連用形 * POS_080 CTYPE_050 CFORM_000 CFORM_011 CFORM_010 CFORM_100";
    is $buffs[1], "ている 持っ モツ 持つ 動詞-一般 動詞 * * 五段-タ行 五段 * 連用形-促音便 連用形 * * * * * * * * * * * * * * * * * * * * * * * * * * * 持っ モツ 持つ 動詞-一般 動詞 * * 五段-タ行 五段 * 連用形-促音便 連用形 * て テ て 助詞-接続助詞 助詞 * * * * * * * * い イル 居る 動詞-非自立可能 動詞 * * 上一段-ア行 上一段 * 連用形-一般 連用形 * て テ て 助詞-接続助詞 助詞 * * * * * * * * い イル 居る 動詞-非自立可能 動詞 * * 上一段-ア行 上一段 * 連用形-一般 連用形 * ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * * * * * * * * * * * * * * * * * * * * * * * * * * * ませ マス ます 助動詞 * * * 助動詞-マス 助動詞 * 未然形-一般 未然形 * POS_100 CTYPE_020 CFORM_000 CFORM_011 CFORM_010 CFORM_100";
