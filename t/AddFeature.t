...
DATA
    ...
    is $lines[0], "詰め ツメル 詰める 動詞-一般 下一段-マ行 連用形-一般 * * 和 動詞 一般 * * 下一段 マ行 * 連用形 一般 * * 0 0";
    is $lines[1], "将棋 ショウギ 将棋 名詞-普通名詞-一般 * * * * 漢 名詞 普通名詞 一般 * * * * * * * * 0 0";
    is $lines[2], "の ノ の 助詞-格助詞 * * * * 和 助詞 格助詞 * * * * * * * * * 0 0";
    is $lines[3], "本 ホン 本 名詞-普通名詞-一般 * * * * 漢 名詞 普通名詞 一般 * * * * * * * * 0 0";
    is $lines[4], "を ヲ を 助詞-格助詞 * * * * 和 助詞 格助詞 * * * * * * * * * 0 0";
    is $lines[5], "買っ カウ 買う 動詞-一般 五段-ワア行-一般 連用形-促音便 * * 和 動詞 一般 * * 五段 ワア行 一般 連用形 促音便 * * 0 0";
    is $lines[6], "て テ て 助詞-接続助詞 * * * * 和 助詞 接続助詞 * * * * * * * * * 0 0";
    is $lines[7], "き クル 来る 動詞-非自立可能 カ行変格 連用形-一般 * * 和 動詞 非自立可能 * * カ行変格 * * 連用形 一般 * * 0 0";
    is $lines[8], "まし マス ます 助動詞 助動詞-マス 連用形-一般 * * 和 助動詞 * * * 助動詞 マス * 連用形 一般 * * 0 0";
    is $lines[9], "た タ た 助動詞 助動詞-タ 終止形-一般 * * 和 助動詞 * * * 助動詞 タ * 終止形 一般 * * 0 0";
...
DATA
    ...
    is $lines[0], "私 ワタクシ 私 代名詞 * * * * 和 代名詞 * * * * * * * * * * 0 0";
    is $lines[1], "と ト と 助詞-格助詞 * * * * 和 助詞 格助詞 * * * * * * * * * 1 0";
    is $lines[2], "し スル 為る 動詞-非自立可能 サ行変格 連用形-一般 * * 和 動詞 非自立可能 * * サ行変格 * * 連用形 一般 * * 1 0";
    is $lines[3], "て テ て 助詞-接続助詞 * * * * 和 助詞 接続助詞 * * * * * * * * * 1 0";
    is $lines[4], "は ハ は 助詞-係助詞 * * * * 和 助詞 係助詞 * * * * * * * * * 0 0";
};
...
DATA
    ...
    is $lines[0], "教え オシエル 教える 動詞-一般 下一段-ア行 連用形-一般 * * 和 動詞 一般 * * 下一段 ア行 * 連用形 一般 * * 0 0";
    is $lines[1], "て テ て 助詞-接続助詞 * * * * 和 助詞 接続助詞 * * * * * * * * * 0 1";
    is $lines[2], "下さい クダサル 下さる 動詞-非自立可能 五段-ラ行 命令形 * * 和 動詞 非自立可能 * * 五段 ラ行 * 命令形 * * * 0 1";
